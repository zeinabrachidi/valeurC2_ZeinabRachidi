<%-- 
    Document   : RegistrationType_Insert
    Created on : Nov 18, 2018, 5:39:45 PM
    Author     : zeina
--%>
...
<html>
    ...
    <body>
        ...
        <form action="RegistrationType_Controller_Insert.jsp" method="post" onsubmit="return checkForm(this);">
            <table align="center">
                <%
